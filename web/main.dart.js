...
l.className="voteButton"
k=document.createElement("label",null)
j=W.dy(null)
i=J.Y(j)
i.soc(j,"vote")
i.st5(j,"radio")
...
j.className="vote"
i.sd4(j,o.Bu())
h=document.createElement("img",null)
J.Yj(h,"images/check_selected copy-01.png")
k.appendChild(j)
k.appendChild(h)
l.appendChild(k)
